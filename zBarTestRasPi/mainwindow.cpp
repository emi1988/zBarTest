    ...
    ui(new Ui::MainWindow)
{
    ...
    QImage qimage;
    bool imgLoaded = qimage.load("/home/pi/Desktop/Projects/zBarTest/codePictures/barcode3.jpg");
    ...
    QImage convertedImage = qimage.convertToFormat(QImage::Format_Indexed8,Qt::MonoOnly);
